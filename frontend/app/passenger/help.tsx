  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.faqText}>- Kijan pou mande yon kous?</Text>
        <Text style={styles.faqText}>- Kijan pou chanje modpas?</Text>
        <Text style={styles.faqText}>- Kijan pou voye plent?</Text>
      </View>
    </SafeAreaView>
  );
}
