  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.faqText}>- Kijan pou kreye admin?</Text>
        <Text style={styles.faqText}>- Kijan pou jere plent?</Text>
        <Text style={styles.faqText}>- Kijan pou modifye pri yo?</Text>
      </View>
    </SafeAreaView>
  );
}
